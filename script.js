document.addEventListener('DOMContentLoaded', () => {
    ...
    const professionalExperience = [
        ...
        { role: 'Business Operations Manager / Site Engineer', company: 'Polar Power Inc.', location: 'Windhoek, Namibia', period: 'July 2018 – Aug 2020', description: 'Led operations for multinational telecommunications and renewable energy company', logo: companyLogos['Polar Power Inc.'], points: [{ title: 'Key Achievements', items: ['Successfully constructed 10 telecommunication towers for MTC (Namibia\'s largest carrier)', 'Secured contract to design and deliver 2 portable WiFi trailer masts to BoFiNet (Botswana)', 'Managed optical fiber installation project in Swakopmund'] }] },
    ...
    const hassenfeldFellowship = {
        ...
        locations: [
            ...
            { name: 'India (2024)', points: ['Engaged with industry leaders: Varun Beverages (Pepsi bottler), Mahindra Group (automotive/conglomerate), ICICI Prudential (financial services), Welspun (textiles/infrastructure), Dabur (FMCG/consumer goods), Bharti Airtel (telecommunications)', 'Visited National Stock Exchange of India', 'Met with innovative companies: Mobikwik (payment platform), Tata Group', 'Studied UPI payment system and India Stack — primary inspiration for Buffr'] }
        ]
    };
